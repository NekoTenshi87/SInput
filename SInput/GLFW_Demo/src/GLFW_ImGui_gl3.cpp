...
void GLFW_ImGui_GL3_RenderDrawLists(ImDrawData* draw_data)
{
...
static const char* GLFW_ImGui_GL3_GetClipboardText(void* user_data)
{
    return glfwGetClipboardString((GLFWwindow*)user_data);
}

static void GLFW_ImGui_GL3_SetClipboardText(void* user_data, const char* text)
{
    glfwSetClipboardString((GLFWwindow*)user_data, text);
}

void GLFW_ImGui_GL3_MouseButtonCallback(GLFWwindow*, int button, int action, int /*mods*/)
{
    if (action == GLFW_PRESS && button >= 0 && button < 3)
        g_MouseJustPressed[button] = true;
}

void GLFW_ImGui_GL3_ScrollCallback(GLFWwindow*, double /*xoffset*/, double yoffset)
{
    g_MouseWheel += (float)yoffset; // Use fractional mouse wheel, 1.0 unit 5 lines.
}

void GLFW_ImGui_GL3_KeyCallback(GLFWwindow*, int key, int, int action, int mods)
{
    ImGuiIO& io = ImGui::GetIO();
...
void GLFW_ImGui_GL3_CharCallback(GLFWwindow*, unsigned int c)
{
    ImGuiIO& io = ImGui::GetIO();
    if (c > 0 && c < 0x10000)
...
bool GLFW_ImGui_GL3_CreateFontsTexture()
{
    // Build texture atlas
    ImGuiIO& io = ImGui::GetIO();
...
bool GLFW_ImGui_GL3_CreateDeviceObjects()
{
    // Backup GL state
...
#undef OFFSETOF
    ...
    GLFW_ImGui_GL3_CreateFontsTexture();
...
{
    if (!g_FontTexture)
      GLFW_ImGui_GL3_CreateDeviceObjects();
...
/*
void GLFW_ImGui_GL3_ShowLog(bool* p_open)
{
  ...
  log_app.Draw("Debug Window", p_open);
}*/